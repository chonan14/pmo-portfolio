export const SITE = {
  ...
  description:
    '「決まらない・進まない・炎上した」プロジェクトを、目的の達成に向けて全力で支援する統括PMO。PMO実務歴 約10年。国家インフラ規模の全社案件（全国セールス部門の統括PMO）から危機対応・官民連携・0→1の制度設計まで。IPA専門委員（eKYCガイドライン策定）。',
  locale: 'ja_JP',
  lang: 'ja',
  themeColor: '#102a4c',
...
export const HERO = {
  headline: 'その難プロジェクト、\n止めずに、前へ進める。',
  sub: '「何を決めるべきか分からない」「対立で進まない」「炎上した」「前例がなく形にできない」——止まった・始まらないプロジェクトで、何を・どの順で決めるかを可視化し、目的への道筋を描く統括PMOです。',
} as const;
...
export const BENEFITS: readonly { title: string; body: string }[] = [
  {
    title: '目的への道筋を、可視化する',
    body: '依頼を作業で終わらせず、目的への貢献まで見据えて関わる。進捗・完了・課題を情報として整理し、経営層とPMが同じ粒度で判断できる状態を整えます。',
  },
  {
    title: '意思決定を速める仕組みを設計する',
    body: '経営と現場が同じ粒度で判断できる状態をつくり、「何を・誰を・どの順で」決めるかを可視化。停滞の根本を切り分け、解消への道筋を引きます。',
  },
  {
    title: 'リスクを低減する体制を構築する',
    body: '炎上・遅延・対立を、責任論を排して事実ベースで整理する。火種を先に潰し、安全に前進できる体制を設計します。',
  },
  {
    title: '立ち上がりから、即戦力',
    body: '国家インフラ規模の全社案件で全国セールス部門の統括PMOを経験。危機対応・官民連携の知見を活かし、初動から状況と論点を可視化し、進め方を立案します。',
  },
];
...
export const PROCESS: readonly { step: string; title: string; body: string }[] = [
  ...
  { step: '03', title: '参画・推進', body: '初動から論点を可視化し、決めるべき順番を整理して、目的への道筋を引きます。' },
];
...
export const FAQ: readonly { q: string; a: string }[] = [
  ...
  {
    q: '立ち上がりは速いですか？',
    a: '現場を知り尽くした統括として、参画初動から状況・論点を可視化。最初の数週間で「何を・どの順で決めるか」「進め方」を立案し、提案します。',
  },
  {
    q: '炎上・対立した現場にも入れますか？',
    a: '責任論を排し、事実整理・影響最小化・確定事項の迅速決定へ論点を切り分けるのが得意領域です。',
  },
  {
    q: '契約・稼働の条件は？',
...
export const POSITIONING =
  '上流から下流、そして制度まで。全体像と“つながり”を見通すから、止まった現場を根本から立て直せる。';

/** 価値提案＝「安心」の定義 */
export const VALUE_PROP = {
  headline: '任せて、前に進む。',
  body:
    '依頼された作業をこなすだけで終わらせず、その先の「目的への貢献」まで見据えて関わる。判断の材料を組み立て、経営層とPMの意思決定を支える——それが私の提供価値です。',
} as const;

/** 信念・哲学 */
export const PHILOSOPHY =
  '声の大きさではなく、目的にとっての正しさで判断する。私は周りとの対話を大切にしながら、自分の判断基準を持ち続けることを心がけている。';

/** モットー（信条）＝本人の声。主語は常に「私」 */
export const MOTTO = {
  headline: '私は、ひとつの車輪として全力を尽くす',
  body: '私はプロジェクトの一つの車輪です。うまく行く保証はしません。けれど、与えられた条件と環境の中で、私の100%を出し続けることは誓います。成否はプロジェクトそのものや仲間の力にもよる——だから私は、外部要因を言い訳にも手柄にもしません。語れるのはいつも「私が何をするか」だけ。その一点に、誠実であり続けます。',
} as const;
...
export const VALUE_STAGES: readonly {
...
}[] = [
  {
    ...
    emphasis: '最も得意',
    strong: true,
    body: '不確実性の中で道を作り、新しい概念を世に出す。前例のない制度・事業・仕組みをゼロから形にする——私が最も得意とするフェーズです。',
  },
  {
    stage: '1 → 10',
    label: '拡大・推進',
...
export const VOICES: readonly Voice[] = [
  {
    quote: '君なら、任せたことを正しく前へ進める。その判断を信じている。',
