...
export const HERO = {
  headline: 'その難プロジェクト、\n完遂へ全力を尽くす。',
  sub: '「何を決めるべきか分からない」「対立で進まない」「炎上した」「前例がなく形にできない」——止まった・始まらないプロジェクトの、目的の達成に向けて全力を尽くす統括PMOです。',
} as const;
...
export const BENEFITS: readonly { title: string; body: string }[] = [
  {
    title: '“完遂”へ、全力を尽くす',
    body: '依頼を作業で終わらせず、目的への貢献まで見据えて取り組む。進捗・完了報告に力を注ぎ、経営層とPMの信頼構築に全力を尽くします。',
  },
  {
    title: '意思決定を速める仕組みを設計する',
    body: '経営と現場が同じ粒度で判断できる状態づくり、「何を・誰を・どの順で」決めるかの可視化に力を注ぎ、停滞解消への道筋をつくります。',
  },
  {
    title: 'リスクを低減する体制を構築する',
    body: '炎上・遅延・対立を、責任論を排して事実ベースで収束させることに、二次被害防止・安全な前進のため全力を尽くします。',
  },
  {
    title: '立ち上がりから、即戦力',
    body: '国家インフラ規模の全社案件で全国セールス部門の統括PMOを経験。危機対応・官民連携の知見を活かし、立ち上がりから全力を注ぎます。',
  },
];
...
export const PROCESS: readonly { step: string; title: string; body: string }[] = [
  ...
  { step: '03', title: '参画・完遂', body: '初動から論点を可視化し、目的の達成に向けて全力で関わります。' },
];
...
export const FAQ: readonly { q: string; a: string }[] = [
  ...
  {
    q: '立ち上がりは速いですか？',
    a: '現場を知り尽くした統括として、参画初動から状況・論点を可視化。最初の数週間で「何を・どの順で決めるか」「進め方」の提案に力を尽くします。',
  },
  {
    q: '炎上・対立した現場にも入れますか？',
    a: '責任論を排し、事実整理・影響最小化・確定事項の迅速決定に論点を集中させることに全力を尽くすのが得意領域です。',
  },
  {
    q: '契約・稼働の条件は？',
...
export const VALUE_PROP = {
  headline: '任せて、前に進む。',
  body:
    '依頼された作業を表面でこなすのではなく、その先の「目的への貢献」まで見据えて取り組む。進捗・完了報告に力を注ぎ、経営層とPMの判断と信頼を支える——それが私の提供価値です。',
} as const;
...
export const MOTTO = {
  ...
  body: '私はプロジェクトの一つの車輪です。うまく行く保証はしません。けれど、与えられた条件と環境の中で、私の100%を出し続けることは誓います。成否はプロジェクトそのものや仲間の力にもよる——だから私は、外部要因を言い訳にも手柄にもしません。語れるのはいつも「私が何に力を注ぐか」だけ。その一点に、誠実であり続けます。',
} as const;
